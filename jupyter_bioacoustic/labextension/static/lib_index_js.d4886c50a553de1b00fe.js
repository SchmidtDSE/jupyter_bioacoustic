...
function readAudioS3(bucket, key, startSec, durSec) {
    ...
    return [
        ...
        `_s3 = _b3.client('s3')`,
        `_bkt, _key = '${(0, util_1.escPy)(bucket)}', '${(0, util_1.escPy)(key)}'`,
        `_raw = None`,
        `try:`,
...
function readAudioUrl(url, startSec, durSec) {
    // Download URL to a cached local file, then read with soundfile
    const u = (0, util_1.escPy)(url);
    return [
...
exports.readAudioUrl = readAudioUrl;
...
class ClipTable {
    ...
    _updateOpSelect() {
        ...
        const ops = (meta === null || meta === void 0 ? void 0 : meta.dtype) === 'float' ? FLOAT_OPS : STRING_OPS;
    ...
    _addFilter() {
        ...
        if (!this._currentOpNeedsValue()) {
            ...
            const meta = this._getSelectedColMeta();
            const val = (meta === null || meta === void 0 ? void 0 : meta.dtype) === 'float' ? parseFloat(raw) : raw;
            if ((meta === null || meta === void 0 ? void 0 : meta.dtype) === 'float' && isNaN(val))
                return;
    ...
    _buildUI() {
        ...
        filterBar.append(filterLbl, this._colSelect, this._opSelect, this._valueContainer, addBtn, this._viewModeSelect, this._refreshBtn);
...
//# sourceMappingURL=lib_index_js.d4886c50a553de1b00fe.js.map